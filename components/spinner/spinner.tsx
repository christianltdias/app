    ...
    <svg className={styles["sp"]} viewBox="0 0 128 128" width="128px" height="128px" xmlns="http://www.w3.org/2000/svg">
		...
		<g fill="none" strokeLinecap="round" strokeWidth="16">
			...
			<g stroke="hsl(190,90%,50%)">
				<path className={styles["sp__worm1"]} d="M120,64c0,30.928-25.072,56-56,56S8,94.928,8,64" stroke="hsl(210,90%,50%)" strokeDasharray="43.98 307.87" />
				<g transform="translate(42,42)">
					<g className={styles["sp__worm2"]} transform="translate(-42,0)">
						<path className={styles["sp__worm2-1"]} d="M8,22c0-7.732,6.268-14,14-14s14,6.268,14,14" strokeDasharray="43.98 175.92" />
					</g>
				</g>
			</g>
			<g stroke="hsl(160,90%,50%)" mask="url(#mask1)">
				<path className={styles["sp__worm1"]} d="M120,64c0,30.928-25.072,56-56,56S8,94.928,8,64" strokeDasharray="43.98 307.87" />
				<g transform="translate(42,42)">
					<g className={styles["sp__worm2"]} transform="translate(-42,0)">
						<path className={styles["sp__worm2-1"]} d="M8,22c0-7.732,6.268-14,14-14s14,6.268,14,14" strokeDasharray="43.98 175.92" />
					</g>
